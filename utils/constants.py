...
THRESHOLD_MA = (
    60 / 100.0
)  # Here we use 60% which is used by other consortiums, 55.3% is the value from Sup's mehod.
...
class NormalizationMethods(object):
    ...
    GLB_99 = (
        "glb_99"  # Normalize by general linear binning with 99th percentile rescaling
    )
